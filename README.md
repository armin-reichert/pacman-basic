...
- User interfaces can be attached to the model/controller layer using the [game event listener](pacman-core/src/main/java/de/amr/games/pacman/event/PacManGameEventListener.java) interface.
