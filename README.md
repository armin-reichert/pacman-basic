...
The code in this project (The sources have moved into repository  [pacman-javafx](https://github.com/armin-reichert/pacman-javafx)) is more "to the point" than the one in my other [state-machine focussed implementation](https://github.com/armin-reichert/pacman).
