...
public class PacManGameSoundAssets {
	...
	private PacManGameSoundAssets() {
		...
		pacManSounds.put(PacManGameSound.PACMAN_EAT_BONUS,   url("/pacman/sound/eat_fruit.wav"));
		...
		msPacManSounds.put(PacManGameSound.PACMAN_EAT_BONUS, url("/mspacman/sound/Fruit.wav"));
