...
public class MsPacManIntermission3_Junior implements PacManGameScene {
	...
	public MsPacManIntermission3_Junior(V2i size, MsPacManGameRendering rendering, SoundManager soundManager,
			MsPacManGame game) {
		this.size = size;
	...
	@Override
	public void start() {
		soundManager.loopSound(PacManGameSound.INTERMISSION_3, 1);
	}
